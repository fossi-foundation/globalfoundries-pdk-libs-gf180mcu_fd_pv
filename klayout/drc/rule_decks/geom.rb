...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(poly2_drawn, 'poly2')
...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(metal1_drawn, 'metal1')
  ...
  offgrid_angle_check(metal2_drawn, 'metal2')
...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(metal3_drawn, 'metal3')
...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(metal4_drawn, 'metal4')
...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(metal5_drawn, 'metal5')
...
GF180_DRC_REGISTRY.register(
  ...
  offgrid_angle_check(metaltop_drawn, 'metaltop')
