...
GF180_DRC_REGISTRY.register(
  ...
  path: __FILE__,
  priority: 0,
  tags: %w[all beol dummy dummy_poly2]
) do
  #================================================
  #---------------------POLY2----------------------
  #================================================
  ...
  # Rule DPF.1: Dummy Poly2 is generated on top of dummy COMP.
  logger.info('Executing rule DPF.1')
  dpf1_l1 = poly2_dummy.not_covering(comp_dummy)
  dpf1_l1.output('DPF.1', 'DPF.1 : Dummy Poly2 is generated on top of dummy COMP.')
  dpf1_l1.forget
  ...
  # Rule DPF.11: Space to dummy COMP exclude layer (NDMY): 29.7
  logger.info('Executing rule DPF.11')
  dpf11_l1 = poly2_dummy.separation(ndmy, 29.7.um, euclidian)
  dpf11_l1.output('DPF.11', 'DPF.11 : Space to dummy COMP exclude layer (NDMY): 29.7')
  dpf11_l1.forget
  ...
  #  logger.info('Executing rule DPF.12')
  #  dpf12_l1 = poly2_dummy.separation(metal1_drawn, 2.um, euclidian)
  #  dpf12_l1.output('DPF.12', 'DPF.12 : Space of dummy poly2 fill to active circuit metal1: 2')
  #  dpf12_l1.forget
  #
  #  # Rule DPF.13: Space of dummy poly2 fill to active circuit metal2: 2
  #  logger.info('Executing rule DPF.13')
  #  dpf13_l1 = poly2_dummy.separation(metal2_drawn, 2.um, euclidian)
  #  dpf13_l1.output('DPF.13', 'DPF.13 : Space of dummy poly2 fill to active circuit metal2: 2')
  #  dpf13_l1.forget
  #
  # end
  ...
  # Rule DPF.19: Space from dummy poly2 to dummy poly2 excluding layer (PMNDMY): 8
  logger.info('Executing rule DPF.19')
  dpf19_l1 = poly2_dummy.separation(pmndmy, 8.um, euclidian)
  dpf19_l1.output('DPF.19', 'DPF.19 : Space from dummy poly2 to dummy poly2 excluding layer (PMNDMY): 8')
  dpf19_l1.forget
end
