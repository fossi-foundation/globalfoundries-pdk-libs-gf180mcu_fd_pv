...
GF180_DRC_REGISTRY.register(
  ...
  cathode_width = cathode_edges
                  .not_interacting(cathode_edges.interacting(plfuse))
                  .join(cathode_edges.interacting(plfuse))
  ...
  anode_width = anode_edges
                .not_interacting(anode_edges.interacting(plfuse))
                .join(anode_edges.interacting(plfuse))
